package com.shuding.fastnetworklibrary.utils;
...
public class SharedPreferencesHelper {
    ...
    public static Object get(Context context, String key, Object defaultObject) {
	 ...
	 public static <T> void saveList(Context context, List<T> list, String key) {
	...
	public static <T> List<T> getList(Context context, Type typeOfT, String key) {
        List<T> userList = null;
        if (context != null && typeOfT != null) {
            String json = (String) get(context, key,"");
			if(!TextUtils.isEmpty(json)){
            userList = JsonHelper.parserJson2List(json, typeOfT);
			}
		}
